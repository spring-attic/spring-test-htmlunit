...
Before you use the project, you must ensure to update your dependencies. Instructions for both <<building-with-maven>> and <<building-with-gradle>> have been provided below.
